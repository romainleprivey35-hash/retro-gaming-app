...
window.onload = () => { renderMenu(); preload(); };
...
function renderGrid(items) {
    ...
    document.getElementById('view-list').innerHTML = '';
    document.getElementById('view-list').appendChild(grid);
}
...
function handleFloatingClick() {
    ...
    detail.innerHTML = `
        ...
        <img src="${activeData.img}" style="max-height:40%; margin-bottom:20px;">
        <h2>${activeData.title}</h2>
        <p>Console: ${activeData.console}</p>`;
